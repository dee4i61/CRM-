        ...
        <div className="mb-6 flex md:items-center space-x-3">
          ...
          <div className="flex flex-wrap space-x-2 md:space-x-4">
            {["responded", "pending", "date"].map((option) => (
              <button
                key={option}
                className={`px-4 py-2 rounded-full text-lg font-medium ${sortBy === option
              ...
              <li key={query._id}>
                ...
                >
                  ...
                  <div className="flex items-center">
                    <span
                      className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${query.status === "responded"
